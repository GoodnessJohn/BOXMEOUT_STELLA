        ...
        <section className="problem" id="how-it-works">
            <div className="container">
                <div className="section-header">
                    ...
                    <p className="section-subtitle">Centralized platforms and public blockchains aren't built for serious prediction markets.</p>
                </div>
                ...
                <div className="problem-grid">
                    <div className="problem-card">
                        ...
                        <h3>Front-Running</h3>
                        <p>Bots see your public prediction on-chain and manipulate odds before your transaction even settles.</p>
                    </div>
                    <div className="problem-card">
                        <div className="problem-icon">🏦</div>
                        <h3>Centralized Risk</h3>
                        <p>Traditional books can freeze your funds or go bankrupt overnight (Remember FTX?).</p>
                    </div>
                    <div className="problem-card">
                        <div className="problem-icon">💸</div>
                    ...
                    <div className="problem-card">
                        ...
                        <p>Wait days for withdrawals on centralized platforms while they "process" your request.</p>
                    </div>
                </div>
