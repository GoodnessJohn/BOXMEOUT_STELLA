            ...
            <div className="container hero-content">
                <div className="hero-text">
                    ...
                    <p className="hero-description">
                        The world's first private prediction market for wrestling. Zero front-running, ultra-low fees, and instant settlements using commitment-reveal technology.
                    </p>
                    <div className="hero-ctas">
                        <button className="btn btn-primary btn-lg" onClick={onStart}>Sign In</button>
                        <button className="btn btn-outline btn-lg" onClick={onStart}>Explore Markets</button>
                    </div>
                        ...
                        <div className="visual-card card-1">
                            ...
                            <div className="card-prediction">
                                ...
                                <div className="odds-bar">
                                    <div className="odds-fill odds-a" style={{ width: '65%' }}>65%</div>
                                    <div className="odds-fill odds-b" style={{ width: '35%' }}>35%</div>
                                </div>
                            </div>
                            <button className="btn btn-accent btn-block" onClick={onStart}>PLACE SECRET BET</button>
                        </div>
                    </div>
                </div>
            </div>
