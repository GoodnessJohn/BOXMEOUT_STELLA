...
const ContactUs = ({ onNav }) => {
    ...
    return (
        <div className="page-wrapper">
            ...
            <main className="container" style={{ paddingTop: "150px", minHeight: "80vh" }}>
                ...
                <div className="glass-panel" style={{ padding: "4rem", marginBottom: "8rem" }}>
                    <div style={{ color: "var(--color-text-muted)", fontSize: "1.2rem", lineHeight: "1.8" }}>
                        <h1>Coming soon</h1>
